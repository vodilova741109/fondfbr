 ...
 * 
 *
 * используется в header, выводится рядом с лого
 *
 * @param bool $echo Echo or return the html.
 ...
 *
 * Извлекает и отображает мета поста.
 *
 ...
 *
 * Отображает значки SVG в меню социальных ссылок. 
 *
 ...
 *
 * Добавляет условные классы для body
 *
