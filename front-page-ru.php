...
?>
      ...
      <div class="slider-wrapper" id="slider-1">
							...
							?>
								...
								<picture class = "wrapper-img">
									...
									<div class="lower-content">
										...
										<a href="<?php echo get_permalink( $page->ID); ?>" class="read-more">Подробнее</a>									
									</div>
								</div>
							<?php 
						}
		...
		<div class="container">
		    ...
		    <section class="wrapper">
				<div class="content-text">
					<h2>Миссия «Фонда борьбы с репрессиями»</h2>
					<div class="bold-text">ФБР - Некоммерческая организация, основанная при содействии российского предпринимателя Евгения Пригожина.</div>
					<p>Миссия организации «Фонд борьбы с репрессиями» - борьба за права человека во всем мире, поддержка гражданских активистов, юридическая помощь и финансовая поддержка жертвам судебно-полицейского произвола и политических преследований. Деятельность Фонда будет направлена на информационную, правовую и иную помощь всем, кто столкнулся с несправедливостью со стороны представителей государства. </p>
				</div>
			...
			<h2>СТАЛИ ЖЕРТВОЙ ПОЛИЦЕЙСКОГО ПРОИЗВОЛА?</h2>
			<section class="wrapper">
			
			
			<?php echo do_shortcode('[contact-form-7 id="5090" title="Контактная форма"]'); ?>
			...
			<section>
				<div class="imag"> 
					<h2>ФОНД ВЗАИМОДЕЙСТВУЕТ СО СЛЕДУЮЩИМИ ПРАВОЗАЩИТНЫМИ ОРГАНИЗАЦИЯМИ </h2>
				...
				<section>
					...
					if ( $query->have_posts() ) {
						while ( $query->have_posts() ) {
							...
							<a href="<?php echo get_category_link(8); ?>" class="link-button">ДРУГИЕ СВИДЕТЕЛЬСВА РЕПРЕССИЙ</a>
											...
											?>
												<div class="inner-box slider-item">
													...
													<div class="lower-content">
														...
														<a href="<?php echo get_permalink( $page->ID); ?>" class="read-more-slider">Подробнее</a>									
													</div>
												</div>
											<?php 
										}
		...
		<div class="container">	
				<section class="fact">					
					<div class="floated-text-fact">Факты</div>	
						<h2>Факты репрессий</h2>
						<div class="wrapper-block">
							...
							<div class="auto-container">
								<a href="<?php echo get_category_link(10); ?>">ПОКАЗАТЬ ЕЩЕ + </a>
							</div>			
